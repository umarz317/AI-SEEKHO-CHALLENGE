// app/recommendation.js — Screen 4: Best match
...
export default function RecommendationScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: M.bg }}>
      <TopBar title="Best match" subtitle="Top of 3 providers" onBack={() => router.back()} />
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 14, paddingBottom: 24 }}>
        <MCard style={{ marginBottom: 12 }}>
          <View style={{ padding: 16 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 14, alignItems: 'flex-start', marginBottom: 14 }}>
              ...
              <View style={{ flex: 1 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                  <Text style={{ fontSize: 17, fontWeight: '800', color: M.text, letterSpacing: -0.2 }}>{p.name}</Text>
              ...
              <View style={{ backgroundColor: M.accentSoft, borderRadius: 7, paddingHorizontal: 9, paddingVertical: 4,
            ...
            {/* Stats grid */}
            <View style={{ flexDirection: 'row', backgroundColor: M.surfaceLow,
              borderRadius: 12, borderWidth: 1, borderColor: M.divider, overflow: 'hidden', marginBottom: 14 }}>
              {[
                ...
                <View key={i} style={{ flex: 1, padding: 10, alignItems: 'center',
            ...
            {/* Why */}
            <Text style={{ fontSize: 10, fontWeight: '700', color: M.textDim, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 7 }}>
              Why this provider
            </Text>
          ...
          {/* Match score footer */}
          <View style={{ backgroundColor: M.accentSoft, padding: 14,
        ...
        {/* Alternatives */}
        <TouchableOpacity onPress={() => setShowAlt(v => !v)} style={{
          flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
          paddingVertical: 8, marginBottom: 4,
        }}>
          <Text style={{ fontSize: 13, fontWeight: '700', color: M.text }}>Other options · {MDATA.alternatives.length}</Text>
              ...
              <MCard key={i} style={{ padding: 14 }}>
                <View style={{ flexDirection: 'row', gap: 12, alignItems: 'center' }}>
                  ...
                  <Text style={{ fontSize: 11, fontWeight: '700', color: M.textMute,
                    backgroundColor: M.surfaceLow, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 6 }}>
                    {alt.score}
                  </Text>
                </View>
              </MCard>
        ...
        <View style={{ marginTop: 10 }}>
          <AccentBtn onPress={() => router.push({ pathname: '/loading', params: { dest: 'booking' } })}>
            Confirm booking
          </AccentBtn>
        </View>
      </ScrollView>
